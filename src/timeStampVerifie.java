...
public class timeStampVerifie{
    ...
    public static void verifyCertificateCRLs(X509Certificate cert)
            ...
            List<String> crlDistPoints = new ArrayList<String>();//= getCrlDistributionPoints(cert);
            crlDistPoints.clear();
            crlDistPoints.add("http://ep.nbusr.sk/snca/archive2/SNCA2-20171101-030045GMT-SN17125.crl");
    ...
    public static List<String> getCrlDistributionPoints(
        ...
        ASN1ObjectIdentifier derObjCrlDP = (ASN1ObjectIdentifier) oAsnInStream.readObject();
        ASN1String dosCrlDP = (ASN1String) derObjCrlDP;
        byte[] crldpExtOctets = ((DERIA5String) dosCrlDP).getOctets();
        ASN1InputStream oAsnInStream2 = new ASN1InputStream(
                new ByteArrayInputStream(crldpExtOctets));
        ASN1ObjectIdentifier derObj2 = (ASN1ObjectIdentifier) oAsnInStream2.readObject();
